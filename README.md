...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyro-api-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12138&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyro-api-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyro-api` can be installed with:

```
conda install pyro-api
```

It is possible to list all of the versions of `pyro-api` available on your platform with:
